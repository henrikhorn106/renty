...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFFEB5E28);
  late Color secondaryColor = const Color(0xFF252422);
  late Color tertiaryColor = const Color(0xFFA92F00);
  late Color alternate = const Color(0xFFEB5E28);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFFCF2);
